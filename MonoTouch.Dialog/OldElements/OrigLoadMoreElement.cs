...
{
	public class OrigLoadMoreElement : Element, IElementSizing
	{
		static NSString key = new NSString ("OrigLoadMoreElement");
		public string NormalCaption { get; set; }
		public string LoadingCaption { get; set; }
		public UIColor TextColor { get; set; }
		public UIColor BackgroundColor { get; set; }
		public event Action<OrigLoadMoreElement> Tapped = null;
		public UIFont Font;
		public float? Height;
		UITextAlignment alignment = UITextAlignment.Center;
		bool animating;
		
		public OrigLoadMoreElement () : base ("")
		{
		}
		
		public OrigLoadMoreElement (string normalCaption, string loadingCaption, Action<OrigLoadMoreElement> tapped) 
			: this (normalCaption, loadingCaption, tapped, UIFont.BoldSystemFontOfSize (16), UIColor.Black)
		{
		}
		
		public OrigLoadMoreElement (string normalCaption, string loadingCaption, Action<OrigLoadMoreElement> tapped, 
			UIFont font, UIColor textColor) : base ("")
		{
